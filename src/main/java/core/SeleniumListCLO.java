...
public class SeleniumListCLO{
	...
	@Parameter(names={sLIST, LIST}, variableArity = true, description ="URL & title, separated by '|' ")
	public static List<String> list;

public static void main(String [] args) 
	{
		new JCommander (new SeleniumListCLO(), args);
		if (help){
		new JCommander (new SeleniumListCLO(), args).usage();
		System.exit(0);
		}
